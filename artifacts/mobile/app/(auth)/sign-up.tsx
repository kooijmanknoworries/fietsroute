...
export default function SignUpScreen() {
    ...
    return (
      ...
      >
        ...
        <Text style={[styles.subtitle, { color: colors.mutedForeground, fontFamily: "Inter_400Regular" }]}>
          We hebben een code gestuurd naar {emailAddress}
        </Text>
        ...
        >
          {fetchStatus === "fetching" ? (
            ...
            <Text style={[styles.primaryBtnText, { fontFamily: "Inter_600SemiBold" }]}>Bevestigen</Text>
          )}
        </TouchableOpacity>
  ...
  return (
    ...
    >
      ...
      <Text style={[styles.subtitle, { color: colors.mutedForeground, fontFamily: "Inter_400Regular" }]}>
        Bewaar je routes en open ze op al je apparaten
      </Text>
      ...
      >
        {fetchStatus === "fetching" ? (
          ...
          <Text style={[styles.primaryBtnText, { fontFamily: "Inter_600SemiBold" }]}>Registreren</Text>
        )}
      </TouchableOpacity>
