...
const en = {
  ...
  "muni.label": "Find a Municipality",
  "muni.searchButton": "Search gemeente (NL/BE)...",
  "muni.inputPlaceholder": "Type a municipality name...",
  "muni.searching": "Searching...",
  "muni.noResults": "No municipalities found.",
  "muni.typeMore": "Type at least 2 characters to search.",
  "muni.removeFavorite": "Remove favorite",
  "muni.setFavorite": "Set as favorite start area",
  "muni.opensAtPrefix": "Opens at",
  "muni.clearFavorite": "Clear favorite",
  ...
  "toast.favRemoved.title": "Favorite removed",
  "toast.favRemoved.desc": '"{name}" is no longer your start area.',
  "toast.favSet.title": "Favorite set",
  "toast.favSet.desc": 'The map will open at "{name}" next time.',
  "toast.favCleared.title": "Favorite cleared",
...
const nl: Record<TranslationKey, string> = {
  ...
  "muni.label": "Zoek een gemeente",
  "muni.searchButton": "Zoek gemeente (NL/BE)...",
  "muni.inputPlaceholder": "Typ een gemeentenaam...",
  "muni.searching": "Zoeken...",
  "muni.noResults": "Geen gemeenten gevonden.",
  "muni.typeMore": "Typ minstens 2 tekens om te zoeken.",
  "muni.removeFavorite": "Favoriet verwijderen",
  "muni.setFavorite": "Instellen als favoriet startgebied",
  "muni.opensAtPrefix": "Opent bij",
  "muni.clearFavorite": "Favoriet wissen",
  ...
  "toast.favRemoved.title": "Favoriet verwijderd",
  "toast.favRemoved.desc": '"{name}" is niet langer je startgebied.',
  "toast.favSet.title": "Favoriet ingesteld",
  "toast.favSet.desc": 'De kaart opent volgende keer bij "{name}".',
  "toast.favCleared.title": "Favoriet gewist",
